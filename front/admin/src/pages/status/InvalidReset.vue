			...
			v-col.pt-0.pb-0(cols="12", md="4", offset-md="4")
				v-row
					v-col.pt-0.pb-0(cols="12")
						.invalid-reset-panel
							img.invalid-reset-logo(src="/assets/images/logo.png")
							p.dashboard-title
								|Enlace inválido
							v-alert.simple-message(border="right", colored-border, type="error", elevation="2", prominent)
								|El enlace de recuperación de cuenta al que has ingresado es inválido.
		...
		methods: {
			...
			submitLogin: function(){
				if( this.$refs.loginForm.validate() ){
					...
					let url = this.baseApi + this.env + "user/login"
