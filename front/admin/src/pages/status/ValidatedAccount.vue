			...
			v-col.pt-0.pb-0(cols="12", md="4", offset-md="4")
				v-row
					v-col.pt-0.pb-0(cols="12")
						.validated-account-panel
							img.validated-account-logo(src="/assets/images/logo.png")
							p.dashboard-title
								|Verificación exitosa
							p.simple-message
								span
									|La cuenta ha sido verificada correctamente, ahora puedes disfrutar de lo que Investus tiene para tí.
							p.login-message
