			...
			v-col.pt-0.pb-0(cols="12", md="4", offset-md="4")
				v-row
					v-col.pt-0.pb-0(cols="12")
						.validate-error-panel
							img.validate-error-logo(src="/assets/images/logo.png")
							p.dashboard-title
								|Validación incorrecta
							v-alert.simple-message(border="right", colored-border, type="error", elevation="2", prominent)
								|El enlace al que has ingresado es inválido. Probablemente la cuenta ya haya sido validada.
