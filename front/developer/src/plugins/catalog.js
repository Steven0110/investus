...
const catalog = {
    ine_anverso: {
        name: "INE o Pasaporte (Anverso)",
        type: "ine_anverso",
        description: "Fotografía de la parte frontal del documento de identificación",
        accept: "image/*",
    ...
    ine_reverso: {
        name: "INE o Pasaporte (Reverso)",
        type: "ine_reverso",
        description: "Fotografía de la parte trasera del documento de identificación.",
        accept: "image/*",
        uploadText: "Da click o arrastra una imagen",
        helper: {
            images: [
    ...
    reporte_credito: {
        name: "Reporte de crédito especial",
        type: "reporte_credito",
        description: "Documento en formato PDF del Reporte de Crédito especial",
        uploadText: "Da click o arrastra un PDF",
        accept: "application/pdf",
        required: true
    },
    ...
    estudio_consolidado: {
        name: "Estudio consolidado",
        type: "estudio_consolidado",
        description: "Documento en formato PDF que contenga lo siguiente: estudio de mercado, estudio de viabilidad, estado de resultados, estado de flujos y balance general. Todo con información de los últimos 3 meses.",
        uploadText: "Da click o arrastra un PDF",
        accept: "application/pdf",
        required: false
    },
