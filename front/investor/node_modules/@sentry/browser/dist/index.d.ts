export * from '@sentry/browser/src/exports';
import { Integrations as CoreIntegrations } from '@sentry/core';
import * as BrowserIntegrations from '@sentry/browser/src/integrations';
import * as Transports from '@sentry/browser/src/transports';
