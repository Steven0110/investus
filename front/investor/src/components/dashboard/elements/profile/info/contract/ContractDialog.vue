<template lang="pug">
	v-dialog(content-class="contract-dialog", :value="value", persistent, max-width="80%", max-height="70%")
		v-card
			v-card-title
				|Contrato entre partes
			v-card-text
				|Lorem, ipsum dolor sit amet consectetur adipisicing elit. Soluta perspiciatis maxime expedita modi illum est omnis molestias eos optio nostrum enim dicta nihil dignissimos unde, veniam. Quam culpa blanditiis, rem.
			v-card-actions
				v-spacer
	...
	export default {
		...
		methods: {
			...
			download: function(key) {
				//documentos/contract/pdf-pPhSf.pdf
